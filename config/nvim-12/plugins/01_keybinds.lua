...
_G.xyz.keybind_set("n", "<C-w><S-j>", "<cmd>resize +2<cr>", "Increase window height")
_G.xyz.keybind_set("n", "<C-w><S-k>", "<cmd>resize -2<cr>", "Decrease window height")
_G.xyz.keybind_set("n", "<C-w><S-h>", "<cmd>vertical resize -2<cr>", "Decrease window width")
_G.xyz.keybind_set("n", "<C-w><S-l>", "<cmd>vertical resize +2<cr>", "Increase window width")

_G.xyz.keybind_set("n", "<C-d>", "<C-d>zz", "Scroll down and center cursor")
_G.xyz.keybind_set("n", "<C-u>", "<C-u>zz", "Scroll up and center cursor")

_G.xyz.keybind_set("n", "n", "nzzzv", "Move to next search result and center cursor")
_G.xyz.keybind_set(
  "n",
  "N",
  "Nzzzv",
...
_G.xyz.keybind_set("i", "<A-j>", "<esc><cmd>m .+1<cr>==gi", "Move current line down")
_G.xyz.keybind_set("i", "<A-k>", "<esc><cmd>m .-2<cr>==gi", "Move current line up")
...
_G.xyz.keybind_set({ "i", "n" }, "<esc>", "<cmd>noh<cr><esc>", "Escape and clear hlsearch")
