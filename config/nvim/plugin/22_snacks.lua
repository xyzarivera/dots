...
-- lazygit
_G.xyz.keybind_set("n", "<leader>gg", function()
  require("snacks").lazygit.open()
end, "LazyGit")
_G.xyz.keybind_set("n", "<leader>gf", function()
  require("snacks").lazygit.log_file()
end, "LazyGit: Current File Commit History")
_G.xyz.keybind_set("n", "<leader>gl", function()
  require("snacks").lazygit.log()
end, "LazyGit: Git Log")

-- picker
_G.xyz.keybind_set("", "<leader><space>", function()
  Snacks.picker.smart({
    filter = {
      paths = {
...
_G.xyz.keybind_set("", "<leader>,", function()
...
_G.xyz.keybind_set("", "<leader>n", function()
  Snacks.picker.notifications()
end, "Picker: Notification History", { remap = true })
-- find
_G.xyz.keybind_set("", "<leader>fb", function()
  Snacks.picker.buffers()
end, "Picker: Buffers", { remap = true })
_G.xyz.keybind_set("", "<leader>fc", function()
  ---@diagnostic disable-next-line: assign-type-mismatch
  Snacks.picker.files({ cwd = vim.fn.stdpath("config") })
end, "Picker: Find Config File", { remap = true })
_G.xyz.keybind_set("", "<leader>ff", function()
  Snacks.picker.files()
end, "Picker: Find Files", { remap = true })
_G.xyz.keybind_set("", "<leader>fg", function()
  Snacks.picker.git_files()
end, "Picker: Find Git Files", { remap = true })
_G.xyz.keybind_set("", "<leader>fp", function()
  Snacks.picker.projects()
end, "Picker: Projects", { remap = true })
_G.xyz.keybind_set("", "<leader>fr", function()
